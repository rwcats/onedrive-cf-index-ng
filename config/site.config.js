...
module.exports = {
  ...
  // your email being exposed in public.
   userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'dkt@krachi.onmicrosoft.com',
  ...
  protectedRoutes: ['/Khác', '/Nhạc', '/Phầnmềm-Ứngdụng-Game', '/Public', '/Sách', '/Truyện tranh', '/Web', '/Xload', '/Ứng dụng', '/Yorak'],
